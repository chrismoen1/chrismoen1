...
public class FriendAdapater extends FirebaseRecyclerAdapter<Friend,FriendAdapater.FriendHolder> {

    final static int USER_NAME = 1;
    final static int LOCATION = 2;
    final static int PROFILE_IMAGE = 3;
     ...
     * @param options
     */
    public FriendAdapater(@NonNull FirebaseRecyclerOptions<Friend> options) {
        super(options);
    }
    ...
    public FriendHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        LinearLayout userProfileView = createUserProfileView("loading...", "", context);
        return new FriendHolder(userProfileView);
    }
    ...
    public LinearLayout createUserProfileView(String profileName, String location, Context context){
        ...
        TextView follow = createUserText_BackDrop("Follow", 15, R.drawable.rounded_border, context);
        ...
        circleImageView.setTag(PROFILE_IMAGE);
    ...
    private TextView createUserText_BackDrop(String text, float textSize, int rounded_border, Context context) {
        TextView textView = new TextView(context);
        textView.setText(text);
        textView.setTextSize(textSize);
        textView.setBackground(ContextCompat.getDrawable(context,R.drawable.rounded_border));
